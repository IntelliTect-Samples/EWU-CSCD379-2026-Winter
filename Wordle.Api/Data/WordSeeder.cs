...
namespace Wordle.Api.Data
{
    public static class WordSeeder
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            var words = GetCommonFiveLetterWords();

            foreach (var wordText in words)
            {
                context.Words.Add(new Word { Text = wordText });
            }

            await context.SaveChangesAsync();
        }

        private static List<string> GetCommonFiveLetterWords()
        {
            return new List<string>
            {
                // Common 5-letter words suitable for Wordle
                ...
                "audio", "avoid", "awake", "award", "aware", "badly", "baker", "bases", "basic",
                "basis", "beach", "began", "begin", "being", "below", "bench", "billy", "birth",
                "black", "blade", "blame", "blind", "block", "blood", "board", "boost", "booth",
                "bound", "brain", "brand", "bread", "break", "breed", "brief", "bring", "broad",
                "broke", "brown", "build", "built", "buyer", "cable", "calif", "carry", "catch",
                "cause", "chain", "chair", "chart", "chase", "cheap", "check", "chest", "chief",
                "child", "china", "chose", "civil", "claim", "class", "clean", "clear", "click",
                "clock", "close", "coach", "coast", "could", "count", "court", "cover", "crack",
                "craft", "crash", "crazy", "cream", "crime", "cross", "crowd", "crown", "crude",
                "cycle", "daily", "dance", "dated", "dealt", "death", "debut", "delay", "delta",
                "dense", "depth", "doing", "doubt", "dozen", "draft", "drama", "drank", "drawn",
                ...
                "paper", "paris", "parks", "party", "peace", "peter", "phase", "phone", "photo",
                ...
                "table", "taken", "taste", "taxes", "teach", "teeth", "terry", "texas", "thank",
                "theft", "their", "theme", "there", "these", "thick", "thing", "think", "third",
                "those", "three", "threw", "throw", "tight", "times", "title", "today", "topic",
                "total", "touch", "tough", "tower", "track", "trade", "train", "treat", "trend",
                "trial", "tribe", "trick", "tried", "tries", "troop", "truck", "truly", "trust",
                ...
                "drape", "eagle", "stare", "slate", "crate", "shale", "whale", "grape", "brake",
                "shake", "snake", "stake", "flake", "awake", "blade", "shade", "spade", "trade",
                "grade", "braid", "trail", "snail", "quail", "grail", "flail", "email"
            };
        }
    }
}
